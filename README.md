...
I can't guarantee it's foolproof tho. Because there is also no encryption what so ever, so anyone on the same network can just sniff and read your files.
Also, there is a possible RCE could be exploited and executed on the server if you have a malicious client, so be ware!
